...
function guardarCambios() {
    ...
    axios.put(`http://127.0.0.1:8000/productos/${id}`, {
        nombre: nombre,
...
try {
    if (id) {
        ...
        const response = await axios.put(`http://127.0.0.1:8000/productos/${id}`, productoData);
        ...
        const response = await axios.post('http://127.0.0.1:8000/productos', productoData);
